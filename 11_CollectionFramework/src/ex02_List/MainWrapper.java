...
public class MainWrapper {
  ...
  public static void ex01() {
   ...
   List<String> season;                     // 부모타입 : List
    
   // ArrayList 생성
   season = new ArrayList<String>();        // 자식타입 : ArrayList
   
   // 배열 요소 추가하기
   season.add("여름");                      // 인덱스 0에 여름 입력
   season.add("가을");                      // 인덱스 1에 여름 입력
   season.add("겨울");                      // 인덱스 2에 여름 입력
   season.add(0,"봄");                      // 인덱스 0에 봄 입력
   
   // 한칸씩 밀려 인덱스 0부터 봄, 여름, 가을, 겨울이 입력된다.
  ...
  public static void ex05() {
    ...
    // ArrayList 초기화
    List<Integer> numbers = Arrays.asList(10, 20, 30, 40); //asList -> 원하는 갯수만큼 넣을수있음(...)
