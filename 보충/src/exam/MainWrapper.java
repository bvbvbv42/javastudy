...
public class MainWrapper {
  ...
  public static void q6() {
    ...
    System.out.println("75832원은 다음과 같습니다.");
  ...
  public static void q7() {
	...
	// 카프리카 수 판별하기
  // 2자리(10~99) 또는 4자리 수(1000 ~ 9999) 대상	
   ...
   for(int dan=2; dan <= 5; dan++) {
	...
	public static void q14() {
	  ...
	  String strScore = "65";
		...
		if(score >= 70) {
      gift = gift + "도마";    // gift += "행주"
    }if(score >= 80) {
      gift = gift + "식칼";    // gift += "행주"
    }if(score >= 90) {
      gift = gift + "냄비";    // gift += "행주"
    }
