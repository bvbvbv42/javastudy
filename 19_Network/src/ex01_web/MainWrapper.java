...
public class MainWrapper {
  ...
  public static void ex01() {
    ...
    /*       *******************중요**********************
     ...
     3. 형식
      프로토콜://    호스트      :포트/ URLMapping ?파라미터=값&파라미터=값&파라미터=값...                            
         https://search.naver.com:8080/search.naver?where=nexearch&sm=top_sug.pre&fbm=0&acr=4&acq=%ED%8F%AD%EC%97%AC&qdt=0&ie=utf8&query=폭염
         https://search.naver.com:8080/search.naver?where=nexearch&sm=top_sug.pre&fbm=0&acr=4&acq=%ED%8F%AD%EC%97%AC&qdt=0&ie=utf8&query=%ED%8F%AD%EC%97%BC
    ...
    // URL 정보 분석하기
    String apiURL = "https://search.naver.com:8080/search.naver?where=nexearch&sm=top_sug.pre&fbm=0&acr=4&acq=%ED%8F%AD%EC%97%AC&qdt=0&ie=utf8&query=폭염";
    ...
    try {
      ...
      // URL 객체 생성
      url = new URL(apiURL);    // MalformedURLException 발생  (형태가 잘못됨)
  ...
  public static void ex02() {
    ...
    try {
      ...
      /*
       요청 메소드
       1. GET  :  주소(URL)를 이용한 데이터 전송     //GET 방식으로 요청이 들어갔다.
