...
public class MainWrapper {
  ...
  // 1.oracle.jdbc.OracleDriver 클래스 Load(메모리 로드)
  public static void ex01() {
    ...
    } catch (ClassNotFoundException e) {   // 클래스를 못찾겠다.
  ...
  // 2. java.sql.Connection 객체 생성 (DB 접속 생성) java.sql에있는 connection
  public static void ex02() {
    ...
    try {
      ...
      System.out.println("DB 접속 실패");   //접속정보중 잘못된게있을경우
    } finally{
  ...
  // 3. 접속 정보를 별도의 파일(프로퍼티 파일)에 저장 
  // 이유 : .gitignore 대비(git을 돌아다니는 봇에 대비)
