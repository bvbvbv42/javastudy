...
public class Library {
  ...
  private void modifyBook() {
    ...
    System.out.println(title + "가진 책이 없습니다.");
  ...
  public void manage() {
    ...
    while(true) {
      ...
      System.out.println("1등록 2.삭제 3.수정 4.조회 5.전체조회 0.종료");
      String choice = sc.next();

      
      switch(choice) {
      case"1": addBook(); break;           // break => switch를 끝내라
      case"2": deleteBook(); break;
      case"3": modifyBook(); break;
      case"4": queryBook(); break;
      case"5": queryAllBook(); break;
      case"0": System.out.println("도서관리프로그램을 종료합니다."); return;   //void 메소드 종료
