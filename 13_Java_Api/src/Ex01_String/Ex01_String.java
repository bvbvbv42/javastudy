...
//문자열 리터럴"은 큰따옴표( " " )로 묶은 소스 문자 집합의 문자 시퀀스입니다
...
public class Ex01_String {
  ...
  public static void ex01() {
    ...
    // 문자열 리터럴 비교 , isEqual =name1과 name2의 참조값을 비교
  ...
  public static void ex02() {
    ...
    // 문자열 객체 비교 , isEqual =name1과 name2의 참조값을 비교
  ...
  public static void ex03() {
    ...
    boolean isEqual2 = name2.equals(name3); // 대소문자도 일치해야 동일한 문자열로 인식한다.
  ...
  public static void ex08() {
    ...
    int idx2 = statement.indexOf("걱정", idx1 + 1);    // 6     첫번째 걱정 다음 걱정까지
  ...
  public static void ex11() {
    ...
    // isBlank 메소드
    // 1. "빈 문자열" 이거나, 공백 문자로 구성되었따면 true 반환 아니면 false 반환
  ...
  public static void ex12() {
    ...
    // 출력 폭 조정
    System.out.println(String.format("%5d", number));    // 5자리 10진수로 표시, 숫자를 오른족 정렬한다.
    System.out.println(String.format("%-5d", number));   // 5자리 10진수로 표시, 숫자를 왼쪽으로 정렬한다.
    System.out.println(String.format("%05d", number));   // 5자리 10진수로 표시, 숫자를 오른족 정렬한다. 빈 자리를 0으로 채움
 
    
    System.out.println(String.format("%10s", str));   // 10자리 문자열 표시, 문자를 오른족 정렬한다. 
    
    System.out.println(String.format("%-10s", str));   // 10자리 문자열 표시, 문자를 왼쪽 정렬한다. 
  ...
  public static void ex15() {
    ...
    // 3. matches    : 지정된 정규식 패턴으로 포함하면 true 반환
    // 4. replaceAll : 지정된 정규식 패턴을 만족하는 부분을 다른 문자열로 변환(정규식)
